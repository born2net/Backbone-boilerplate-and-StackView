/**
 ...
 @class OrientationSelectorWaspView
 @constructor
 @return {Object} instantiated OrientationSelectorWaspView
 **/
define(['jquery', 'backbone'], function ($, Backbone) {

    BB.SERVICES.ORIENTATION_SELECTOR_VIEW = 'OrientationSelectorWaspView';
    BB.CONSTS.VERTICAL = 'VERTICAL';
    BB.CONSTS.HORIZONTAL = 'HORIZONTAL';
    BB.CONSTS.ORIENTATION = 'ORIENTATION';

    var OrientationSelectorWaspView = BB.View.extend({
    ...
    return OrientationSelectorWaspView;
