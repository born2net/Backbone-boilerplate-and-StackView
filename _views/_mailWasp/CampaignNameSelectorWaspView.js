...
define(['jquery', 'backbone'], function ($, Backbone) {
    ...
    BB.SERVICES.CAMPAIGN_NAME_SELECTOR_VIEW = 'CampaignNameSelectorWaspView';

    var CampaignNameSelectorWaspView = Backbone.View.extend({
    ...
    return CampaignNameSelectorWaspView;
